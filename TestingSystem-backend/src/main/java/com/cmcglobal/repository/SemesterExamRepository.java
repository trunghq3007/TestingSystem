...
@Repository
public interface SemesterExamRepository extends JpaRepository<SemesterExam, String>,SemesterExamCustorm {
	...
	List<SemesterExam> findAllByOrderByCreatedDateDesc();
}
